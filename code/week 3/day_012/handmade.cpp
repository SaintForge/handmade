...
internal void
GameOutputSound(game_sound_ouput_buffer * SoundBuffer, int ToneHz)
{
...
GameUpdateAndRender(game_offscreen_buffer *Buffer, int BlueOffset, int GreenOffset,
		    game_sound_ouput_buffer *SoundBuffer, int ToneHz)
{
     // TODO(Max): Allow sample offsets here for more robust platform options
